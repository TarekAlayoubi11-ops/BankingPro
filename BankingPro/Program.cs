...
using BankingPro.Authorization;
...
namespace BankingPro
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                options.AddPolicy("BankingproApiCorsPolicy", policy =>
                {
                    policy
                        .WithOrigins(
    ...
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            ValidIssuer = "BankingproApi",

            ValidAudience = "BankingproApiUsers",
    ...
    {
        {
            ...
            app.UseCors("BankingproApiCorsPolicy");
